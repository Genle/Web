    ...
    let nav = `
     <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
        <ul id="nav-mobile" class="left hide-on-med-and-down">
            ...
            <li><a id="reorder"  onclick='check()' href=${config['env'][environment]['reorder']}>Re-Order</a></li>
        ...
        <ul class="nav-mobile right hide-on-med-and-down">
         ...
         <ul class="side-nav red darken-2 center-align" id="mobile-demo">
            ...
            <li><a id="reorder" onclick='check()' class="white-text" href=${config['env'][environment]['reorder']}>Re-Order</a></li>
...
exports.tableBtn = (dateStr) => {
    ...
    if (seconds < 120) {
        buttons = `<td>
                    <button class="btn red darken-2 white-text hoverable">Re-order</button>
                    <button id={{@index}} class="btn red darken-2 white-text hoverable">Cancel</button>
                    </td>`;
    } else {
        buttons = `<td>
                    <button class="btn red darken-2 white-text hoverable">Re-order</button>
                    <button disabled id={{@index}} class="btn red darken-2 white-text hoverable">Cancel</button>
                    </td>`;
    }
